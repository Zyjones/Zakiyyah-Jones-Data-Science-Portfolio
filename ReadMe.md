...
Zakiyyah = {
    "pronouns": ["she", "her"],
    "code": ["Python", "SQL"],
    "ask_me_about": ["data science", "data analysis", "puzzles", "Applied Behavior Analysis"],
    "fun_fact": "Pandas are my favorite animal and library!"
}
```

## Projects
<img align="left" width="250" height="150" src="Lila & Lola logo copy.jpg" style="margin-right: 20px; margin-bottom: 10px;">
...
Utilizing a dataset of 1 million bank transactions and machine learning techniques to create a classifier that detects fraudulent activity in transactions.  
